...
const ECommerceLaravelApi = api
    ...
    .injectEndpoints({
        endpoints: (build) => ({
            ...
            updateECommerceShippingStatus: build.mutation<UpdateECommerceOrderApiResponse, { id: string; shipping_status: string }>({
            ...
            // Update only the shipping status of an order
            updateECommerceProductShippingStatus: build.mutation<UpdateECommerceOrderApiResponse, { id: string; shipping_status: string }>({
                query: ({ id, shipping_status }) => ({
