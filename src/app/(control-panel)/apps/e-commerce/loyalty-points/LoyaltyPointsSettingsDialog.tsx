...
import { useGetLoyaltyPointsSettingsQuery, useUpdateLoyaltyPointsSettingsMutation } from './apis/LoyaltyPointsApi';
...
function LoyaltyPointsSettingsDialog({ open, onClose }: LoyaltyPointsSettingsDialogProps) {
	...
	const handleSave = async () => {
		try {
			...
			console.log(
				...
				typeof settings.loyalty_points_enabled
			);
	...
	return (
		...
		>
			<DialogTitle
				id="loyalty-points-settings-dialog-title"
				sx={{ pb: 1 }}
			>
				<Box
					display="flex"
									...
									>
										...
										>
											<CardContent>
												...
												>
													Example: {settings.loyalty_points_per_dollar} point
													{settings.loyalty_points_per_dollar !== 1 ? 's' : ''} per{' '}
													{currencySymbol}1 spent
												</Typography>
											</CardContent>
										</Card>
									</Grid>
										...
										>
											<CardContent>
												...
												<TextField
													...
													onChange={(e) =>
														handleChange(
															'loyalty_points_dollar_per_point',
															parseFloat(e.target.value) || 0
														)
													}
												...
												<Typography
													...
													sx={{ mt: 1, display: 'block' }}
												>
													{Math.round(1 / settings.loyalty_points_dollar_per_point)} points ={' '}
													{currencySymbol}1 discount
												</Typography>
											</CardContent>
										</Card>
									</Grid>
