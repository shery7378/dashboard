				...
				<Box className="flex flex-col gap-4 p-4">
					...
					<Alert severity="info">
						<Typography variant="body2">
							<strong>Credit Terms:</strong> Set credit limits and payment terms for sellers. When sellers
							import products from your wholesale catalog, they can choose to pay instantly or use credit.
						</Typography>
					</Alert>
											...
											{creditTerms.map((term) => (
												<TableRow key={term.id}>
													...
													<TableCell>
														<Chip
															label={
																term.payment_method === 'credit' ? 'Credit' : 'Instant'
															}
															color={
																term.payment_method === 'credit' ? 'primary' : 'default'
															}
															size="small"
														/>
													</TableCell>
								...
								<FormControl fullWidth>
									...
									<Select
										...
										onChange={(e) =>
											setFormData({
												...formData,
												payment_method: e.target.value as 'instant' | 'credit'
											})
										}
									>
