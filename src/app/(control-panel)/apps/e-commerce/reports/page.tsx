							...
							<ReactApexChart
								...
								options={{
									...
									grid: {
										...
										row: { colors: ['#fafafa', 'transparent'], opacity: 0.6 }
									},
									plotOptions: {
										bar: { columnWidth: '45%', borderRadius: 8, borderRadiusApplication: 'end' }
									},
									tooltip: {
										shared: true,
										intersect: false,
												...
												? [
														{
															...
															label: {
																text: `Peak ${currency.format(maxSales)}`,
																borderColor: '#6366F1',
