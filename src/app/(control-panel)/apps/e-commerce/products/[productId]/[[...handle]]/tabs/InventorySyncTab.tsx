...
function InventorySyncTab({ productId, userRole: propUserRole }: InventorySyncTabProps) {
	...
	const [syncDirection, setSyncDirection] = useState<'supplier_to_vendor' | 'vendor_to_supplier' | 'bidirectional'>(
		'supplier_to_vendor'
	);
									...
									<CardContent>
										<Box className="flex justify-between items-start mb-2">
											<Box>
												...
												<Typography
													...
													color="text.secondary"
												>
													Supplier Product: {sync.supplier_product_id} | Vendor Product:{' '}
										...
										<Box className="flex gap-2 mt-4">
											...
											<Button
												...
												size="small"
												onClick={() =>
													handleDisableSync(sync.supplier_product_id, sync.vendor_product_id)
												}
			...
			<Card>
				<CardContent>
					...
					>
						...
						<br />• Bidirectional sync allows both parties to sync inventory to each other
					</Typography>
				</CardContent>
			</Card>
		</Box>
