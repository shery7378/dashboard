                            ...
                            >
                                ...
                                >
                                    ...
                                    <MenuItem value="price">
                                        <Box display="flex" alignItems="center" gap={1}>
                                            <FuseSvgIcon sx={{ fontSize: 18 }}>heroicons-outline:currency-pound</FuseSvgIcon>
                                            Price Low-High
                                        </Box>
                                    </MenuItem>
                                </Select>
                                    ...
                                    <Grid item xs={12} sm={6} md={4} lg={4} xl={4} key={index}>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                />
                                                <CardContent sx={{ p: 3 }}>
                                                    <Skeleton height={28} width="80%" sx={{ mb: 1.5 }} />
                                                    <Skeleton height={20} width="60%" sx={{ mb: 1 }} />
                                                    <Skeleton height={16} width="90%" sx={{ mb: 1 }} />
                                    ...
                                    >
                                        ...
                                        >
                                                ...
                                                label={
                                                    <Box display="flex" alignItems="center" gap={0.5}>
                                                        <FuseSvgIcon sx={{ fontSize: 14 }}>
                                                            {quantity > 0 ? 'heroicons-outline:check-circle' : 'heroicons-outline:x-circle'}
                                                        </FuseSvgIcon>
                                            ...
                                            {priceTaxIncl > 0 && (
                                                ...
                                                >
                                                    <FuseSvgIcon sx={{ fontSize: 16 }}>heroicons-outline:currency-pound</FuseSvgIcon>
