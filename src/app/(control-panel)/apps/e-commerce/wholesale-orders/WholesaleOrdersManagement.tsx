								...
								<Card>
									<CardContent>
										...
										<Typography variant="h4">
											£{Number(statistics.total_revenue).toFixed(2)}
										</Typography>
									</CardContent>
								</Card>
							</Grid>
								...
								<Card>
									<CardContent>
										...
										<Typography
											...
											color="warning.main"
										>
											£{Number(statistics.pending_payment).toFixed(2)}
										</Typography>
									</CardContent>
								</Card>
							</Grid>
										...
										<TableBody>
											{orders.map((order) => (
												<TableRow key={order.id}>
													...
													<TableCell>{order.supplier_product?.name || 'N/A'}</TableCell>
								...
								>
									...
									>
										...
										>
											...
											<Typography variant="body1">
												{selectedOrder.supplier_product?.name}
											</Typography>
										</Grid>
										<Grid
											item
										...
										>
											...
											<Typography variant="body1">
												{selectedOrder.payment_method === 'instant'
													? 'Instant Payment'
													: `Credit (${selectedOrder.credit_days} days)`}
											</Typography>
										</Grid>
							...
							>
								...
								<FormControl fullWidth>
									...
									<Select
										...
										label="Order Status"
										onChange={(e) =>
											setFormData({ ...formData, order_status: e.target.value as any })
										}
									>
										<MenuItem value="pending">Pending</MenuItem>
										<MenuItem value="processing">Processing</MenuItem>
