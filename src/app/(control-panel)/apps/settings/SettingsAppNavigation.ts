...
const SettingsAppNavigation: FuseNavItemType = {
	...
	url: '/apps/settings',
	auth: authRoles.admin, //why this will work and hide from navigation
	children: [
		{
			...
			auth: authRoles.admin, //why this will not work and not hide from navigation
		...
		},
		{
			...
			subtitle: 'Manage payment gateway credentials and settings'
		}
	]
};
