...
import { useGetAdminProductFeesSettingsQuery, useUpdateAdminProductFeesSettingsMutation } from './ProductFeesAdminApi';

export default function ProductFeesSettingsPage() {
	const { data, isFetching, isError, error, refetch } = useGetAdminProductFeesSettingsQuery(undefined, {
					...
					>
						<CardHeader
							...
							subheader={
								...
								>
									Set a global fee that applies to all products. Choose between a fixed amount or a
								...
								>
									...
									>
										<ul style={{ margin: 0, paddingLeft: 20 }}>
											<li>
												<strong>Fixed Amount:</strong> A constant fee added to every product
												regardless of price.
											</li>
											<li>
												<strong>Percentage:</strong> A fee calculated as a percentage of each
												product's price.
											</li>
										</ul>
										<Typography
										...
										>
											Note: This is a global setting that applies to all products. Individual
											product fees can be overridden at the product level if needed.
										</Typography>
									</Typography>
								</Alert>
							</Box>
