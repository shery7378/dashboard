...
const ProductFeesAdminApi = api.enhanceEndpoints({ addTagTypes }).injectEndpoints({
	endpoints: (build) => ({
...
export const { useGetAdminProductFeesSettingsQuery, useUpdateAdminProductFeesSettingsMutation } = ProductFeesAdminApi;
