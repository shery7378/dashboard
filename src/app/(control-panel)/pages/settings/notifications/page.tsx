...
export default function NotificationSettingsPage() {
	...
	const [updateSettings, { isLoading }] = useUpdateAdminNotificationProviderSettingsMutation();
												...
												<Switch
													...
													onChange={async (e) => {
														...
														try {
															...
															setError(
																err?.data?.message ||
																	'Failed to update SMS notification settings.'
															);
															// Revert on error
															setGlobalSMSEnabled(!newValue);
														}
									...
									>
										...
										>
											<TextField
												...
												helperText={
													testEmailAddress
														? `Email will be sent to: ${testEmailAddress}`
														: 'If empty, email will be sent to your account email'
												}
												sx={{
													'& .MuiOutlinedInput-root': {
														borderRadius: 2
									...
									>
										...
										>
											<TextField
												...
												helperText={
													testPhoneNumber
														? `SMS will be sent to: ${testPhoneNumber}`
														: 'If empty, SMS will be sent to your account phone number'
												}
												sx={{
													'& .MuiOutlinedInput-root': {
														borderRadius: 2
