...
const NotificationsAdminApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      updateAdminNotificationSettings: build.mutation<UpdateAdminNotificationSettingsResponse, UpdateAdminNotificationSettingsArg>({
...
export type UpdateAdminNotificationSettingsArg = Pick<NotificationSettings, 'enabled' | 'email_enabled' | 'sms_enabled'>;
