...
const CurrencyRatesAdminApi = api
  ...
  .injectEndpoints({
    endpoints: (build) => ({
      ...
      updateAdminCurrencyRates: build.mutation<
        UpdateAdminCurrencyRatesResponse,
        UpdateAdminCurrencyRatesArg
      >({
        query: (body) => ({
