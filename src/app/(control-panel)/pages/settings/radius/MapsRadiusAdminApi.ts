...
const MapsRadiusAdminApi = api.enhanceEndpoints({ addTagTypes }).injectEndpoints({
	endpoints: (build) => ({
		...
		updateAdminMapsRadiusSettings: build.mutation<
			UpdateAdminMapsRadiusSettingsResponse,
			UpdateAdminMapsRadiusSettingsArg
		>({
...
export const { useGetAdminMapsRadiusSettingsQuery, useUpdateAdminMapsRadiusSettingsMutation } = MapsRadiusAdminApi;
