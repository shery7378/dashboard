...
import { TextField, Box, CircularProgress, Typography, Slider, Button, Alert } from '@mui/material';
	...
	return (
		...
		>
			...
			>
				...
				>
					Latitude: {latitude.toFixed(6)}, Longitude: {longitude.toFixed(6)}, Radius: {radius} km
				</Typography>
