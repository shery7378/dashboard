...
import {
  useGetAdminCurrencySettingsQuery,
  useUpdateAdminCurrencySettingsMutation,
} from './CurrencySettingsAdminApi';
...
export default function CurrencySettingsPage() {
  const {
    ...
    error,
    refetch,
  } = useGetAdminCurrencySettingsQuery(undefined, {
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, mt: 1 }}>
                ...
                >
                  ...
                  {COMMON_CURRENCIES.map((code) => (
                    <MenuItem key={`common-${code}`} value={code}>
                      {code}
                    </MenuItem>
                  ))}
                </TextField>
              ...
              <Button
                ...
                sx={{
                  ...
                  '&:hover': {
                    ...
                    background:
                      'linear-gradient(135deg, #0ea5e9 0%, #38bdf8 40%, #0284c7 100%)',
                  },
                }}
              >
