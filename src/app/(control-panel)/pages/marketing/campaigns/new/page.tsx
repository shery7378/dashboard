							...
							>
								...
								>
									<TextField
										...
										helperText={
											fieldErrors.name || `${form.name.length}/${MAX_NAME_LENGTH} characters`
										}
							...
							>
								...
								>
									<TextField
										...
										helperText={
											fieldErrors.title || `${form.title.length}/${MAX_TITLE_LENGTH} characters`
										}
										...
										<Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
											<TextField
												...
												helperText={
													jsonError ||
													fieldErrors.target ||
													'Optional: Define targeting rules as JSON'
												}
												multiline
												minRows={3}
												maxRows={6}
							...
							{form.name || form.title || form.message ? (
								<Box>
									<Box sx={{ mb: 2 }}>
										...
										<Chip
											label={channelLabels[form.channel] || form.channel}
											size="small"
											sx={{ ml: 1 }}
										/>
									</Box>
