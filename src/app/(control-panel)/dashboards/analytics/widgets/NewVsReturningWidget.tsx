...
const selectNewVsReturning = selectWidget<NewVsReturningWidgetType>('newVsReturning');

/**
 * New vs. returning widget.
 * Removed the awaitRender anti-pattern that caused an extra blank render cycle.
 * Uses stable selector and memoized chart options.
 */
function NewVsReturningWidget() {
	const theme = useTheme();
	const widget = useAppSelector(selectNewVsReturning);
