...
export default function SellerAnalyticsApp() {
	...
	const {
		...
		error: productsError
	} = useGetTopProductsQuery({ limit: 10 });

	const sales = salesData?.data ?? [];
	const topProducts =
		topProductsData?.data ??
		([] as { product_id: number; product_name: string; total_sales: number; orders: number }[]);
												...
												<Box>
													...
													{loadingProducts ? (
														...
														<>
															...
															>
																{topProduct
																	? currency.format(Number(topProduct.total_sales))
																	: ''}
															</Typography>
														</>
													)}
												...
												<ReactApexChart
													...
													options={{
														...
														xaxis: {
															...
															labels: { rotateAlways: true, rotate: -25, trim: true }
														},
														plotOptions: {
															bar: {
																horizontal: false,
														...
														legend: { show: false },
														tooltip: {
															y: { formatter: (val: number) => currency.format(val) }
														}
													}}
											...
											{loadingProducts ? (
												...
												>
													...
													>
														<TableHead>
															<TableRow>
																<TableCell sx={{ fontWeight: 800, bgcolor: 'grey.50' }}>
																	Product
																</TableCell>
																<TableCell
																	align="right"
																	sx={{ fontWeight: 800, bgcolor: 'grey.50' }}
																>
																	Orders
																</TableCell>
																<TableCell
														...
														<TableBody>
															{topProducts.map((p: any) => (
																...
																>
																	...
																	<TableCell align="right">
																		{currency.format(Number(p.total_sales) || 0)}
																	</TableCell>
																</TableRow>
															))}
														</TableBody>
