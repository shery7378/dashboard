...
import { useGetProfilesQuery, useCreateProfileMutation, useUpdateProfileMutation } from '@/app/(control-panel)/(user)/account/apis/ProfileApi';
...
const Root = styled(FusePageCarded)(({ theme }) => ({
    '& .FusePageCarded-header': { minHeight: 72, height: 72, alignItems: 'center', [theme.breakpoints.up('sm')]: { minHeight: 136, height: 136 } },
