...
export default function AuthButton({
  ...
  const variantClasses = {
    primary:
      "bg-[#FF6B35] text-white hover:bg-[#FF5722] disabled:bg-gray-300 disabled:text-gray-500",
    secondary:
      "bg-gray-100 text-gray-700 hover:bg-gray-200 disabled:bg-gray-200 disabled:text-gray-400",
    outline:
