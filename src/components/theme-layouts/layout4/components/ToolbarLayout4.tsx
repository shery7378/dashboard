...
// import { Layout4ConfigDefaultsType } from '@/components/theme-layouts/Layout4/Layout4Config';
import useThemeMediaQuery from '../../../../@fuse/hooks/useThemeMediaQuery';
import { Layout4ConfigDefaultsType } from '../Layout4Config';

type ToolbarLayout4Props = {
	className?: string;
};

/**
 * The toolbar layout 4.
 */
function ToolbarLayout4(props: ToolbarLayout4Props) {
...
export default memo(ToolbarLayout4);
